...
{
    int age,health,city,male,premium,pa;
	health = male = city = age = 0;
			...
			if (health && male && city)
				{
					premium = 4;
					pa = 200000;
					printf("Your premium is $%d per 1000 \
and policy limit is $%d\n",premium,pa);
				}
			if (health==1 && male==0 && city==1)
				{
					premium = 3;
					pa = 100000;
					printf("Your premium is $%d per 1000 and policy limit is $%d\n",premium,pa);
				}
			if (health==0 && city==0 && male)
				{
					premium = 6;
					pa = 10000;
					printf("Your premium is $%d per 1000 and policy limit is $%d\n",premium,pa);
